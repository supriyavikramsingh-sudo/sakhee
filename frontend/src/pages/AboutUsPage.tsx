    ...
    <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <p className="text-lg text-muted leading-relaxed">
              ...
              through cutting-edge AI technology combined with deep understanding of Indian culture,
      ...
      <section className="mb-16">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted leading-relaxed mb-4">
            ...
            plans to symptom tracking—is designed to make your PCOS journey more manageable and less
            overwhelming.
          </p>
          <p className="text-lg text-muted leading-relaxed">
            Today, thousands of women across India trust AI Sakhee as their daily health companion,
      ...
      <section className="text-center bg-primary text-white rounded-xl p-12">
        ...
        <p className="text-xl mb-8 max-w-2xl mx-auto">
          Join thousands of women who are taking control of their PCOS with AI Sakhee. Start your
          free trial today!
        </p>
