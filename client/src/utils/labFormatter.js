/**
 * Lab Value Display Name Formatter
 * Converts internal keys to proper medical terminology
 *
 * Usage:
 * import { formatLabName } from './utils/labFormatter'
 * const displayName = formatLabName('homa_ir') // Returns "HOMA-IR"
 */

export const LAB_VALUE_NAMES = {
  // Glucose & Insulin
 ...
 */
export function formatLabName(key) {
...
/**
 * Get category for a lab value
 * @param {string} key - Lab value key
 * @returns {string} - Category name
 */
export function getLabCategory(key) {
  const categories = {
